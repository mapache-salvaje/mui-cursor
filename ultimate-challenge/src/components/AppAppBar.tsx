          ...
          <Box sx={{ display: { xs: 'flex', md: 'none' }, gap: 1 }}>
            ...
            >
              <Box sx={{ p: 2, backgroundColor: 'background.default' }}>
                ...
                <Link href="/pricing" passHref style={{ textDecoration: 'none', color: 'inherit' }}>
                  <MenuItem>Pricing</MenuItem>
                </Link>
                <Link href="/checkout" passHref style={{ textDecoration: 'none', color: 'inherit' }}>
                  <MenuItem>Checkout</MenuItem>
                </Link>
                <Divider sx={{ my: 3 }} />
                <MenuItem>
                  <Link href="/sign-up" passHref style={{ textDecoration: 'none', width: '100%' }}>
                ...
                <MenuItem>
                  <Link href="/sign-in" passHref style={{ textDecoration: 'none', width: '100%' }}>
